				...
				<div class="col-md-2 col-sm-2">
					<div class="logo">
						<a href="index.html"><img
							src="../resource/client/images/Logo2-removebg.png" alt="FlatShop"></a>
					</div>
				</div>
				<div class="col-md-10 col-sm-10">
					<div class="header_top">
						<div class="row">
							<div class="col-md-9 d-flex justify-content-start align-items-center text-light">
                                <%
								...
								<c:if test="${sessionScope.user != null}">
									<ul class="usermenu" style="display: flex;">   
										<li> <a href="profile"><img class="img-circle"
											...
											style="width: 26px; height: 26px; object-fit: cover; margin-top: -4px;">
